...
-	Inconsistent formats: data from different sources, such as csv files, xls, and web-based tables, were not always structured uniformly. This required significant effort to standardize formats and ensure compatibility for analysis.
